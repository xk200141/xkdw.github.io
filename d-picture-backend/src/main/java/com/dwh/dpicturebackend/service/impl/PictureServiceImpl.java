...
import com.dwh.dpicturebackend.api.aliyunai.aliyun.AliYunAiApi;
import com.dwh.dpicturebackend.api.aliyunai.model.CreateOutPaintingTaskRequest;
import com.dwh.dpicturebackend.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.dwh.dpicturebackend.config.CosClientConfig;
...
import com.dwh.dpicturebackend.manager.CosManager;
import com.dwh.dpicturebackend.manager.upload.FilePictureUpload;
import com.dwh.dpicturebackend.manager.upload.PictureUploadTemplate;
import com.dwh.dpicturebackend.manager.upload.UrlPictureUpload;
import com.dwh.dpicturebackend.mapper.PictureMapper;
import com.dwh.dpicturebackend.model.dto.file.UploadPictureResult;
...
import com.dwh.dpicturebackend.service.PictureService;
import com.dwh.dpicturebackend.service.SpaceService;
import com.dwh.dpicturebackend.service.UserService;
import com.dwh.dpicturebackend.utils.ColorSimilarUtils;
...
//        picture.setPicColor(getImageAve(oldPicture.getUrl()));
      boolean  result = this.saveOrUpdate(picture);
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR, "图片上传失败");
...
由于图片上传、用户编辑、管理员更新这 3 个操作都需要设置审核状态*/
    @Override
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        Element div = document.getElementsByClass("dgControl dtl hover").first();
